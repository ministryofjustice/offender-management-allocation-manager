  ...
  context 'with 3 offenders' do
    ...
    before do
      ...
      offenders.each do |offender|
        alloc = create(:allocation, case_information: build(:case_information, nomis_offender_id: offender.fetch(:offenderNo)), primary_pom_nomis_id: pom.staffId, prison: prison)
