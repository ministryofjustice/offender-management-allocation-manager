...
describe SentenceTypeService do
  it "can determine determinate sentences" do
    off = Nomis::OffenderSummary.new.tap { |o| o.imprisonment_status = 'CRIM_CON' }
  ...
  it "can determine indeterminate sentences" do
    off = Nomis::OffenderSummary.new.tap { |o| o.imprisonment_status = 'IPP' }

    expect(described_class.indeterminate_sentence?(off.imprisonment_status)).to eq true
  end

  it "can determine recall sentences" do
    off = Nomis::OffenderSummary.new.tap { |o| o.imprisonment_status = 'LR_HDC' }
