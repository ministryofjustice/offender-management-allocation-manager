module ApiHelper
  def stub_offender(nomis_id, booking_number: 754_165, imprisonment_status: 'SENT03')
    ...
    stub_request(:post, "https://gateway.t3.nomis-api.hmpps.dsd.io/elite2api/api/offender-sentences/bookings").
      ...
      to_return(status: 200, body: [{ offenderNo: nomis_id, bookingId: booking_number, sentenceDetail: {sentenceStartDate: Time.zone.today - 2.months, conditionalReleaseDate: Time.zone.today + 22.months} }].to_json)
