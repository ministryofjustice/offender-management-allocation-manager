  ...
  context 'when offender allocation history', vcr: { cassette_name: :offender_allocation_history } do
    before do
      ...
      create :email_history, nomis_offender_id: nomis_offender_id,
             ...
             created_at: Time.zone.now - 3.weeks
    ...
    it 'shows the case history' do
      ...
      history6 = history[6]
      prescoed_transfer = EmailHistory.welsh_open_prescoed(nomis_offender_id).first
      ...
      [
          ...
          ['.moj-timeline__description', "The LDU for #{prescoed_transfer.name} - #{prescoed_transfer.email} - was sent an email asking them to appoint a Responsible COM."]
