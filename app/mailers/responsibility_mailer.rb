...
class ResponsibilityMailer < ApplicationMailer
  ...
  def responsibility_to_custody_with_pom
    emails, prisoner_name, prisoner_number, prison_name, notes, pom_name, pom_email = params.values_at(:emails, :prisoner_name, :prisoner_number, :prison_name, :notes, :pom_name, :pom_email)
  ...
  def responsibility_to_custody
    emails, prisoner_name, prisoner_number, prison_name, notes = params.values_at(:emails, :prisoner_name, :prisoner_number, :prison_name, :notes)
