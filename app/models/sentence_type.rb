...
SENTENCE_TYPES = {
  ...
  'ADIMP_ORA' => ['ORA CJA03 Standard Determinate Sentence', :determinate, :recall],
  'CUR_ORA' => ['ORA Recalled from Curfew Conditions', :determinate, :recall],
  'DTO_ORA' => ['ORA Detention and Training Order', :determinate, :recall],
  ...
  'SEC91_03_ORA' => ['ORA Serious Offence -18 CJA03 POCCA 2000', :determinate, :recall],
  'YOI_ORA' => ['ORA Young Offender Institution', :determinate, :recall],
  'BOTUS' => ['ORA Breach Top Up Supervision', :determinate, :recall],
  ...
  'LR_SEC236A' => ['LR - Section 236A SOPC CJA03', :determinate, :non_recall]
}
