...
Rails.application.config.assets.paths << Rails.root.join('node_modules/accessible-autocomplete')
Rails.application.config.assets.paths << Rails.root.join('node_modules/accessible-autocomplete/src')
